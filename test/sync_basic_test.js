...
function prepareDataForVerifierTest() {
  ...
  const missing = {};
  missing[address0] = {
    deltas: { 0: crypto.hash(delta0_0), 1: crypto.hash(delta0_1) },
    bytecodeHash: crypto.hash(bytecode)
  };
  ...
  const wrongMsg6 = createSyncMsgForVerifierTest(MsgTypes.SYNC_BCODE_RES, {
    address: address0,
    bytecode: wrongData2
  });
  ...
  const expected = [
    { msg: wrongMsg1, err: expectedErr1, res: false },
    { msg: wrongMsg2, err: expectedErr2, res: false },
    { msg: wrongMsg3, err: expectedErr3, res: false },
    { msg: correctSyncStateMsg, err: null, res: true },
    { msg: wrongMsg4, err: expectedErr4, res: false },
    { msg: wrongMsg5, err: expectedErr5, res: false },
    { msg: wrongMsg6, err: expectedErr6, res: false },
    { msg: wrongMsg7, err: expectedErr7, res: false },
