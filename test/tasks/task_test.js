const Task = require('../../src/worker/task_manager/Task');
const ComputeTask = require('../../src/worker/task_manager/ComputeTask');
const DeployTask = require('../../src/worker/task_manager/DeployTask');
...
it('#1 Should test DeployTask', function(done){
